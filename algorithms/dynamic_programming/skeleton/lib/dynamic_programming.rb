...
class DPProblems
  ...
  def str_distance(str1, str2)
    ans = str_helper(str1, str2)
    @dist_cache = Hash.new { |hash, key| hash[key] = {} }
    ans
  end

  def str_helper(str1, str2)
    ...
    len2 = str2.length
    if str1[0] == str2[0]
      dist = str_helper(str1[1..len1], str2[1..len2])
      @dist_cache[str1][str2] = dist
      return dist
    else
      poss1 = 1 + str_helper(str1[1..len1], str2[1..len2])
      poss2 = 1 + str_helper(str1, str2[1..len2])
      poss3 = 1 + str_helper(str1[1..len1], str2)
