	...
	var GiphysSearch = function (_React$Component) {
	  ...
	  _createClass(GiphysSearch, [{
	    ...
	    value: function handleSubmit(e) {
	      ...
	      e.preventDefault();
	      this.props.fetchSearchGiphys(this.state.searchTerm).then(function () {
	        return _this2.setState({ searchTerm: '' });
	      });
	    }
	  }, {
	    key: 'handleChange',
	      ...
	      if (giphys.length === 0) {
	        ...
	        return _react2.default.createElement(
	          ...
	          giphys.map(function (giphy) {
	            return _react2.default.createElement('img', { src: giphy.images.fixed_height.url });
	          }),
	          ';'
	        );
	      }
